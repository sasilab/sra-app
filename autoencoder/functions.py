...
def autoencode(df, target_feature, progress_callback=None, **kwargs):
    """
    ...
    # Run the autoencoder
    history = autoencoder.run(progress_callback=progress_callback)
